...
const storedOurStory = localStorage.getItem('OurStoryData1')

export const OurStoryData1= storedOurStory ? JSON.parse(storedOurStory) :[
...
if(!storedOurStory){
    localStorage.setItem('OurStoryData1' ,JSON.stringify(OurStoryData1));
}